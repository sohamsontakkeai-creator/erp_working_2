...
const ShowroomDepartment = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // Fetch displayed showroom products
      console.log('Fetching displayed showroom products...');
      const showroomResponse = await fetch(`${API_BASE}/showroom/displayed`);
      if (!showroomResponse.ok) {
        throw new Error(`Showroom API error: ${showroomResponse.status} ${showroomResponse.statusText}`);
      }
      const showroomData = await showroomResponse.json();
      console.log('Showroom data received:', showroomData);
    ...
    <div className="max-w-7xl mx-auto bg-white shadow-md border-b-4 border-blue-800 rounded-b-lg">
      ...
      <div className="px-6 py-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Showroom Department</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <Card className="bg-white border border-gray-300 shadow-sm">
              <CardContent className="p-4">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-gray-600 text-sm font-medium">Products Available</p>
            ...
            <Card className="bg-white border border-gray-300 shadow-sm">
              <CardContent className="p-4">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-gray-600 text-sm font-medium">On Display</p>
                    <p className="text-2xl font-bold text-gray-800 mt-1">
                      {displayedProducts.filter(p => p.showroomStatus === 'available').length}
                    </p>
                  </div>
            ...
            <Card className="bg-white border border-gray-300 shadow-sm">
              <CardContent className="p-4">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-gray-600 text-sm font-medium">Ready for Sales</p>
                    <p className="text-2xl font-bold text-gray-800 mt-1">
                      {displayedProducts.filter(p => p.showroomStatus === 'available').length}
                    </p>
                  </div>
              ...
              <CardContent className="p-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-800 mt-1">
                      {products.filter(p => areAllTestsPassed(p.id)).length}/{products.length}
                    </p>
                  </div>
        ...
        <div className="px-6 mb-8">
          <div className="bg-white border border-gray-300 rounded-sm shadow-sm">
            <div className="border-b border-gray-200 bg-gray-50 px-6 py-4">
              <h2 className="text-xl font-bold text-gray-800">Available Products from Assembly</h2>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="mb-4 pb-4 border-b border-gray-200">
                        <div className="flex items-center justify-between">
                          <span className="text-gray-700 text-sm font-medium">Quality Rating:</span>
                          <div className="flex items-center space-x-1">
                            {[...Array(product.qualityRating || 5)].map((_, i) => (
                              <Star key={i} className="w-4 h-4 text-yellow-500 fill-current" />
                            ))}
                            <span className="text-gray-600 text-sm ml-2">Approved</span>
                          </div>
                        </div>
                      </div>
        ...
        <div className="px-6 mb-8">
          <div className="bg-white border border-gray-300 rounded-sm shadow-sm">
            <div className="border-b border-gray-200 bg-gray-50 px-6 py-4">
              <h2 className="text-xl font-bold text-gray-800">Current Showroom Display</h2>
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <div className="mt-2 space-y-1">
                            ...
                            <p className="text-gray-600 text-sm">
                              <span className="font-medium">Customer Interest:</span> {product.customerInterest || 8}/10
                            </p>
                            <p className="text-gray-600 text-sm">
                        ...
                        <Badge className={`${getStatusColor(product.showroomStatus)} border`}>
                          ...
                          <span className="ml-1 capitalize">{product.showroomStatus}</span>
                        </Badge>
                      </div>
                    </CardHeader>
                    <CardContent className="p-6">
                      <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-gray-600 text-sm ml-2">({product.qualityRating || 5}/5)</span>
                        </div>
                        {product.showroomStatus === 'available' && (
