            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-base font-medium">Procurement Management System</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 px-6 py-4 rounded-lg shadow-sm">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-600 text-xs font-medium">Purchase Management</p>
                </div>
              </div>
            </div>
          ...
          <p className="text-gray-600 text-sm mt-1">Please wait while we retrieve the data</p>
            ...
            <Card className="bg-white border border-gray-300 shadow-sm">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">No Purchase Orders</h3>
                <p className="text-gray-600">Purchase orders from production will appear here.</p>
              </CardContent>
            </Card>
          ) : (
            purchaseOrders.map((order, index) => (
              ...
              >
                <Card className="bg-white border border-gray-300 shadow-sm hover:shadow-md transition-shadow">
                  <CardHeader>
