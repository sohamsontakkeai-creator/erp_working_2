        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Sales Department</h1>
          ...
          {/* User Info Panel */}
          <div className="bg-gradient-to-r from-green-50 to-indigo-50 border-2 border-green-200 px-6 py-4 rounded-lg shadow-sm">
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                <TabsList className="grid w-full grid-cols-5 bg-gray-100 border border-gray-300">
                ...
                <TabsContent value="showroom" className="space-y-6">
                    <div className="flex justify-between items-center">
                        <h2 className="text-2xl font-bold text-gray-800">Available Showroom Products</h2>
                        <Button 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {showroomProducts.map((product) => (
                            <Card key={product.id} className="bg-white border border-gray-300 shadow-sm hover:bg-gray-100 transition-colors">
                                <CardHeader>
                                    <CardTitle className="text-gray-800">{product.name}</CardTitle>
                ...
                <TabsContent value="transport" className="space-y-6">
                    ...
                    <div className="flex justify-between items-center">
                        <h2 className="text-2xl font-bold text-gray-800">After Sales</h2>
                    </div>
                    <Card className="bg-white border border-gray-300 shadow-sm">
                        <CardContent className="p-0">
                            <Table>
