            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold text-gray-900">Assembly Operations</h1>
                    <p className="text-gray-600 text-base font-medium">Product Assembly Management System</p>
                  </div>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <div className="bg-gradient-to-r from-orange-50 to-red-50 border-2 border-orange-200 px-6 py-4 rounded-lg shadow-sm">
                  <div className="flex items-center space-x-3">
          ...
          {orders.length === 0 ? (
            <Card className="bg-white border-2 border-gray-200 shadow-lg">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">No Assembly Orders</h3>
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-gray-600 text-sm font-medium">
                          {/* Prefer purchase order createdAt (IST string) for consistency; fallback to assembly's createdAt */}
                          Created: {(
